...
export default function LinkedinButton() {
  return (
    <Link href="https://www.linkedin.com/in/arpan404/" target="_blank">
      <button className="group hover:bg-sky-600 relative bg-sky-700 rounded-lg text-neutral-50 duration-500 font-medium flex justify-start gap-2 items-center p-2 pr-6">
