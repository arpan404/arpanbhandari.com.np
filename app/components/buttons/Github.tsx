...
export default function Github({ url }: { url: string }) {
  return (
    <Link to={url} target="_blank">
      <button className="group hover:bg-gray-900 relative bg-gray-800 rounded-full text-neutral-50 duration-500 font-bold flex justify-start gap-2 items-center py-2 px-6">
