    ...
    <div className="flex justify-center">
      <LinkPreview url={url}>
        ...
        >
          ...
          <span className="group-hover:opacity-100 group-hover:duration-1000 duration-100 opacity-0 absolute top-0 left-0 z-10 text-sm flex justify-center w-full h-full items-center group-hover:text-neutral-100">
            View My Works
          </span>
        </Button>
      </LinkPreview>
